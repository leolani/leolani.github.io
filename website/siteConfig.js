...
const siteConfig = {
  title: 'The CLTL - Leolani pages',
  tagline: 'All our repositories in a few clicks',
  // url: 'https://your-docusaurus-test-site.com', // Your website URL
  // baseUrl: '/', // Base URL for your project */
  // For github.io type URLs, you would set the url and baseUrl like:
  url: 'https://leolani.github.io',
  baseUrl: '/',

  // Used for publishing and more
  projectName: 'leolani.github.io',
  organizationName: 'leolani',
...
colors: {
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} CLTL - Leolani`,
